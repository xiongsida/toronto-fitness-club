...
from classes.views import ClassesListView, ClassEnrollView, ClassDropView, ClassParentView,ClassScheduleView
...
urlpatterns = [
    ...
    path('alluserhistoryclasses',ClassScheduleView.as_view(),name='alluserhistoryclasses-for-frontend')
]
