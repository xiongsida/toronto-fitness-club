                    ...
                    <Card onClick={
                        ...
                        <Card.Body className="text-center">
                            ...
                            <Link to={'/studios/' + studio.id} state={{ directionAppend: directionAppend }}>
                                <SmallPrimaryButton variant="success" className='mx-1 my-2'> Details </SmallPrimaryButton>
                            </Link>

                            <a href={studio.direction + directionAppend} target='_blank'>
                                <SmallPrimaryButton href={studio.direction + directionAppend} target="_blank" className='mx-1 my-2'> Direction </SmallPrimaryButton>
                            </a>
                            <Link to={'/classes'} state={{ studio_id: studio.id }}>
                                <SmallPrimaryButton variant="info" className='mx-1 my-2'> Class </SmallPrimaryButton>
                            </Link>
                        </Card.Body>
                    </Card>
                </Row>
